...
4.Run the program:python pixel.py
5.Choose:
  5.1 E to encrypt the image
  5.2 D to decrypt the image
6.Enter the password and other required inputs when prompted.
...
This type of technique can be applied in:
1.Secure image sharing
2.Digital watermarking
3.Privacy protection
4.Educational demonstrations of cryptography concepts
