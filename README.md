...
└── output/            # Stores sample outputs or results
```
...
1. Clone the repository:
   ...
   ```
   git clone https://github.com/hemaharini05/PRODIGY_CS_07.git
   ```

2. Navigate to the task folder:

   ```
   cd PRODIGY_CS_07/Task-01-Caesar-Cipher
   ```
...
* **E** → Encrypt a message
* **D** → Decrypt a message
* **B** → Brute-force decryption (all shifts)
...
GitHub: [https://github.com/hemaharini05](https://github.com/hemaharini05)
